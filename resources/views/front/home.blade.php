        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex align-items-center">
                    <div class="left">
                        <h4>Hello, I'm</h4>
                        <h2>Biplob Sutra Dhar </h2>
                        <h3>Professional Web Developer</h3>
                        <p>
                            I am 26 years old web designer & developer; and working to build websites for my international clients.
                        </p>
                        <div class="button">
                ...
                <div class="col-md-6">
                    <div class="right">
                        <img src="{{asset('dist_font/images/profile.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="left wow fadeInLeft">
                        <img src="{{asset('dist_font/images/profile2.jpeg')}}" alt="">
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-12">
                    ...
                    <div class="filter-items">
                        <div class="filter-item web_design">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/design_1.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item web_development">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/development_1.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item web_design">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/design_2.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item digital_marketing">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/marketing_1.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item digital_marketing">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/marketing_2.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item web_development">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/development_2.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item web_design">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/design_3.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item web_development">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/development_3.jpg')}}" alt=""></a></div>
                                <div class="text">
                        ...
                        <div class="filter-item digital_marketing">
                            <div class="inner">
                                <div class="photo"><a href="portfolio-detail.html"><img src="{{asset('dist_font/images/marketing_3.jpg')}}" alt=""></a></div>
                                <div class="text">
